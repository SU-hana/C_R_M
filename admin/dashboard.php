											...
											<div class="panel panel-default">
												<div class="panel-body bk-danger text-light">
													<div class="stat-panel text-center">
														<?php
														$sql = "SELECT id from tblbooking where embking = '1' ";
														...
														<div class="stat-panel-title text-uppercase">Emergency Booking</div>
													</div>
												</div>
												<a href="emergency-bookings.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
										<div class="col-md-3">
											<div class="panel panel-default">
