...
if (isset($_POST['submit'])) {
  ...
  if ($query1->rowCount() == 0) {
    $sql = "INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,message,Status,embking) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:message,:status,:embking)";
    ...
    $query->bindParam(':embking', $embking, PDO::PARAM_STR);
    $query->execute();
              ...
              <div class="sidebar_widget">
                ...
                <form method="post">
                  ...
                  <div class="form-group form-check">
                    <input type="checkbox" class="form-check-input" name="embking" value="1" id="embking">
                    <label class="form-check-label" for="embking">Emergency Booking</label>
                  </div>
